...
function agregarPelicula() {
  ...
  // Validación básica de los campos (podrías agregar más validaciones según tus necesidades)
  if (movieName && movieYear && movieLink && redirectLink) {
    ...
    var containerAllMovies = document.querySelector(".container_allMovies");
    containerAllMovies.appendChild(movieElement);
